...
ActiveRecord::Schema[7.2].define(version: 2026_07_21_120100) do
  ...
  create_table "conversation_messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["identifier"], name: "index_conversation_messages_on_identifier"
  end
  ...
  create_table "pooja_types", force: :cascade do |t|
    t.string "name"
    t.integer "price"
    t.integer "duration"
    t.text "description"
  ...
  add_foreign_key "bookings", "pooja_types", column: "puja_id"
end
